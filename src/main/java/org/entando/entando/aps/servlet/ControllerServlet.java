...
public class ControllerServlet extends freemarker.ext.servlet.FreemarkerServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		MyThreadLocal.set(sessionId + " - " + time);
		*/
		...
		try {
			...
			System.out.println("*********finiti 10 secondi************");
			//System.out.println("sessionId " + MyThreadLocal.get());
			System.out.println("time " + time);
			System.out.println("DATA " + MyThreadLocal.get());
			System.out.println("*********************");
			*/
			...
			*/
			...
			try {
				...
				_logger.error("Error closing connections", e);
			}
			*/
		}
        return;
